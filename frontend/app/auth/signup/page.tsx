        ...
        <div className="relative w-full h-full flex items-center justify-center text-center">
          <div className="space-y-8">
            ...
            <div className="pt-8 border-t border-gray-700">
              <p className="text-gray-500 text-sm mb-4">Create an account to get started</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-12 overflow-y-auto bg-gray-900">
        <div className="w-full max-w-md py-8">
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-400">Join TeamSync AI today</p>
          </div>
          ...
          >
            <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24">
              <path d="M17.05 13.5c-.91 2.92-.46 5.25 1.1 6.82 1.84 1.84 5.03 1.01 6.08-1.81.52-1.39.44-3.3-.27-5.21-1.07-2.78-4.25-4.57-8.47-4.78.64-1.11 1.28-2.78 1.07-4.3-.27-2.4-2.16-4.07-4.57-4.4-1.96-.27-3.95.24-5.22 1.93C3.55 3.75 3.75 5.9 5.62 7.88c.77.77 2.56 1.52 4.41 1.52.13 0 .26 0 .39-.02-1.15 1.64-2.37 3.58-2.37 5.81 0 3.15 2.04 5.31 5 5.81 1.35.23 2.5.12 3.56-.45-.79.27-1.63.58-2.56.58-1.71 0-2.95-1.24-2.95-2.95 0-.71.24-1.37.63-1.92z" />
            </svg>
            Continue with Apple
          </button>
          ...
          <p className="mt-6 text-center text-gray-400">
            ...
            <Link href={redirect ? `/auth/login?redirect=${encodeURIComponent(redirect)}` : "/auth/login"} className="text-blue-400 hover:text-blue-300 font-semibold transition">
              Login
            </Link>
          </p>
        </div>
    ...
    <Suspense fallback={
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Loading Sign Up...</p>
        </div>
      </div>
    }>
      <SignupContent />
